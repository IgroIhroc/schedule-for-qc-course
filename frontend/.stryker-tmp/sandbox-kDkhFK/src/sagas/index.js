...
export default function* startForman() {
  if (stryMutAct_9fa48("7513")) {
    ...
    stryCov_9fa48("7513");
    yield all(stryMutAct_9fa48("7514") ? [] : (stryCov_9fa48("7514"), [watchUserAuthentication(), studentWatcher(), groupWatcher(), watchSemester(), watchLessons(), watchSchedule(), watchRooms(), watchClasses(), watchTeachers(), watchTeacherLessons()]));
  }
}