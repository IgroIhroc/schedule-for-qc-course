...
const mapStateToProps = stryMutAct_9fa48("5141") ? () => undefined : (stryCov_9fa48("5141"), (() => {
  const mapStateToProps = state => stryMutAct_9fa48("5142") ? {} : (stryCov_9fa48("5142"), {
...
export default connect(mapStateToProps)(reduxForm(stryMutAct_9fa48("5143") ? {} : (stryCov_9fa48("5143"), {
