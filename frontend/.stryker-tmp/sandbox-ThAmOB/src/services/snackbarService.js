...
export const handleSnackbarOpenService = (isOpen, type, message) => {
  if (stryMutAct_9fa48("8100")) {
    ...
    stryCov_9fa48("8100");
    store.dispatch(setOpenSnackbar(stryMutAct_9fa48("8101") ? {} : (stryCov_9fa48("8101"), {
      isOpen,
      type,
      message
    })));
...
export const handleSnackbarCloseService = () => {
  if (stryMutAct_9fa48("8102")) {
    ...
    store.dispatch(setOpenSnackbar(stryMutAct_9fa48("8103") ? {} : (stryCov_9fa48("8103"), {
      isOpen: stryMutAct_9fa48("8104") ? true : (stryCov_9fa48("8104"), false),
